...
export function setCharTimeline(
  ...
  let neckBone = character?.getObjectByName("spine006");
  if (window.innerWidth > 1024) {
    if (character) {
      tl1
        .fromTo(character.rotation, { y: 0 }, { y: 0.7, duration: 1 }, 0)
        .to(camera.position, { z: 25 }, 0)
        .fromTo(".character-model", { xPercent: -50 }, { xPercent: -100, duration: 1 }, 0)
      ...
      tl2
        ...
        .fromTo(
          ...
          { pointerEvents: "none", xPercent: -120, delay: 0, duration: 5, immediateRender: false },
          0
        )
      ...
      tl3
        .fromTo(
          ".character-model",
          { xPercent: -120, y: "0%" },
          { xPercent: -50, y: "0%", duration: 4, ease: "none", delay: 1, immediateRender: false },
          0
        )
